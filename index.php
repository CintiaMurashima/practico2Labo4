...
<body>
    <div class="container">
      <form action="action.php" method="post">
        ...
        <div>
          <input type="text" name= "birthday" placeholder="dd/mm/aaaa" class="full-width">
        </div>
        <br/>
        <label for="">Sex:</label>
        ...
        <div>
          <input type="checkbox" name= "data-base">Data Base
          <input type="checkbox" name= "desing">Desing
          <input type="checkbox" name= "business">Business
          <input type="checkbox" name= "unit-test">Unit Test
          <input type="checkbox" name= "cloud-development">Cloud development
